...
namespace _Scripts.Gameplay.CharactersController.Player
{
    /**
     * <summary>
    ...
    public class PlayerController : MonoBehaviour
    {
        ...
        private void StartDodge()
        {
                ...
                && !_isCrouching)
            {
                ...
                // If no Inputs, go forward.
                if (inputDirection == Vector3.zero)
                    _dodgeDirection = transform.forward;
                else
                {   // If there's input, calculate the dodge direction.
                    inputDirection = inputDirection.normalized;
                    _dodgeDirection = _camera.transform.forward * inputDirection.z + _camera.transform.right * inputDirection.x;
                    _dodgeDirection.y = 0;
                }
